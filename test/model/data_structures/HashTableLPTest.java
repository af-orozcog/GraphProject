...
class HashTableLPTest {
	...
	/**
	 * Método que rectifica que el método resizing este funcionando correctamente y mantenga la estructura
	 * del HashTable
	 */
	@Test
	public void resizingTest0() {
		setUpEscenario1();
		Class c = datos.getClass();
		Method privateMethod = null;
		try {
			privateMethod = c.getDeclaredMethod("resizing", int.class);
		}catch(Exception e) {
			e.printStackTrace();
		}
